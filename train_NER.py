...
train_path = "../ENEIDE/DZ/v0.1/json_data/train.json"
...
training_args = TrainingArguments(
    output_dir="./ELITE_models/NER/gliner_dz_b4_e4",
    learning_rate=5e-6,
    weight_decay=0.01,
    others_lr=1e-5,
...
if not os.path.exists("./ELITE_models/NER/"):
    os.makedirs("./ELITE_models/NER/")

trainer.model.save_pretrained("./ELITE_models/NER/gliner_dz_b4_e4")

trained_model = GLiNER.from_pretrained("./ELITE_models/NER/gliner_dz_b4_e4", load_tokenizer=True)
